...
const ModifyVideoTab = lazy(() =>
  import("@/components/VideoCreationPanel/tabs/ModifyVideoTab").then((m) => ({
    default: m.ModifyVideoTab,
  }))
);
const UseVideoReferenceTab = lazy(() =>
  import("@/components/VideoCreationPanel/tabs/UseVideoReferenceTab").then(
    (m) => ({ default: m.UseVideoReferenceTab })
  )
);
const TextToVideoTab = lazy(() =>
  import("@/components/VideoCreationPanel/tabs/TextToVideoTab").then((m) => ({
    default: m.TextToVideoTab,
  }))
);
