...
const TextToImageTab = lazy(() =>
  import("@/components/ImageCreationPanel/tabs/TextToImageTab").then((m) => ({
    default: m.TextToImageTab,
  }))
);
const EditImageTab = lazy(() =>
  import("@/components/ImageCreationPanel/tabs/EditImageTab").then((m) => ({
    default: m.EditImageTab,
  }))
);
const InpaintingTab = lazy(() =>
  import("@/components/ImageCreationPanel/tabs/InpaintingTab").then((m) => ({
    default: m.InpaintingTab,
  }))
);
