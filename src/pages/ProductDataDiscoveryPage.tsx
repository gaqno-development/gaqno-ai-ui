    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          AI Content Engine – discovery (Epic GAQNO-1159). Source: PDV, ERP, CRM.
        </p>
      </div>
      <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-3">
        {(Object.entries(INVENTORY) as [keyof typeof INVENTORY, (typeof INVENTORY)[keyof typeof INVENTORY]][]).map(
          ([system, data]) => (
            <Card key={system}>
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <span className="text-muted-foreground">{data.gapsForAi.join(', ')}</span>
                </div>
              </CardContent>
            </Card>
          )
